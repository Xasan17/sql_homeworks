...
--10
SELECT DepartmentName, COUNT(e.Name) AS EmployeeCount FROM Employees e 
INNER JOIN Departments d ON e.DepartmentID = d.DepartmentID
...
--12
SELECT c.FirstName, c.LastName, COUNT(OrderID) AS TotalOrders FROM Customers c
INNER JOIN Orders o ON c.CustomerID = o.CustomerID
...
INNER JOIN Sales s ON p.ProductID = s.ProductID AND s.SaleAmount >500;
--25
